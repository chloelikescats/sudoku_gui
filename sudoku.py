...
class SudokuUI(Frame):
    ...
    def __draw_grid(self):
        ...
        """
        for i in xrange(10):
            color = "cornflower blue" if i % 3 == 0 else "gray"
        ...
        for i in xrange(9):
            for j in xrange(9):
                ...
                if answer != 0:
                    ...
                    color = "black" if answer == original else "light sea green"
    ...
    def __draw_cursor(self):
        ...
        if self.row >= 0 and self.col >= 0:
            ...
            self.canvas.create_rectangle(
                x0, y0, x1, y1,
                outline="indian red", tags="cursor"
            )
...
def parse_arguments():
    ...
    # Creates a dict of keys = argument flag, and value = argument
